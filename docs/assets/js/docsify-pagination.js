...
var Link = function () {
  function Link(element) {
    ...
    this.hyperlink = findHyperlink(element);
		...
		let badsites = ["introduction", "recover-mii-channel", "recover-ios", "common-issues-fixes", "fix-errcode-112-1037", "about", "block-updates", "unblock-updates", "dump-games", "dump-wii-games", "uninstall-cbhc", "uninstall-indexiine", "faq"]
