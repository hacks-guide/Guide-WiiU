...
<img src="/docs/assets/img/Tiramisu Guide Images/sdroot.png" alt="Root of the SD Card">

1. Copy the `01_sigpatches.rpx` file to `/wiiu/environments/tiramisu/modules/setup` on your SD Card.
<img src="/docs/assets/img/Tiramisu Guide Images/modules.png" alt="Tiramisu Setup Modules on the SD Card">
