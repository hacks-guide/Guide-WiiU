...
| [c2w_patcher Plugin](https://github.com/V10lator/c2w_patcher/) ([Download](https://github.com/V10lator/c2w_patcher/releases)) | Automatically applies c2w_patches for supported titles | 1. Copy the downloaded `c2w_patcher.wps` file to the `wiiu/environments/aroma/plugins` folder on the root of your SD Card. |
