...
| [PriiloaderWiiUForwarder](https://github.com/DacoTaco/priiloader/) ([Download](https://github.com/DacoTaco/priiloader/releases/download/0.10.0-RC3/PriiloaderWiiUForwarder.wuhb)) | Allows you to access Priiloader directly from the Wii U Menu. | Copy the `PriiloaderWiiUForwarder.wuhb` file to the `wiiu/apps` folder on the root of your SD Card. |
