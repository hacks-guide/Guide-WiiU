...
?> **Remarque** Votre carte SD devra être formatée en FAT32. If your SD Card is not formatted to FAT32, use [GUIFormat](http://ridgecrop.co.uk/index.htm?guiformat.htm) with 32k (32768) allocation unit size to format it. Il est conseillé de ne pas nommer la carte SD `wiiu` ou `cbhc` car cela peut causer des problèmes avec certaines applications.
