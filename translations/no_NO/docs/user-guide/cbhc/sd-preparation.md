...
- Siste utgave av [Homebrew Launcher Channel](https://github.com/dimok789/homebrew_launcher/releases/latest)
  - Du må laste ned `homebrew_launcher_channel.v2.1.zip`.
...
- Siste utgave av [Haxchi og CBHC](https://github.com/FIX94/haxchi/releases/latest)
...
1. Opprett en mappe med navnet `Homebrew Launcher Channel` inni `install` mappen.
1. Pakk ut `homebrew_launcher_channel.v2.1.zip` til `Homebrew Launcher Channel` mappen.
