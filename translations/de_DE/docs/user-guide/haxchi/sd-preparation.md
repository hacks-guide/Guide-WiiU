...
1. Entpacke die `nanddumper.zip` Datei in das Stammverzeichnis deiner SD-Karte.
1. Entpacke die `wiiu-extracttosd.zip` Datei in das Stammverzeichnis deiner SD-Karte.
